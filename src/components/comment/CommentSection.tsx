      ...
      <div className="border-2 border-gray-900 p-8">
        {isAuthenticated ? (
          ...
          <div className="text-center py-4">
            <p className="text-base font-mono text-gray-900 mb-6">
              Login with GitHub to leave a comment
            </p>
            <button
              onClick={login}
              className="px-6 py-3 border-2 border-gray-900 text-sm font-mono text-gray-900 hover:bg-gray-900 hover:text-white transition-all inline-flex items-center gap-3"
            >
      ...
      <div className="space-y-8">
        {comments.length === 0 ? (
          <div className="border-t-2 border-gray-200 pt-12 text-center">
            <p className="text-base font-mono text-gray-500">No comments yet.</p>
          </div>
        ) : (

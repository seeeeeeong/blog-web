...
export default function CommentSection({ postId }: CommentSectionProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-md border border-gray-300 bg-white/60 p-4 sm:p-5">
        <div className="mb-4 flex items-center justify-between gap-3">
          <h3 className="font-mono text-xs text-muted uppercase tracking-wide">Comments</h3>
        ...
        {isAuthenticated ? (
          ...
          <div className="rounded-md border border-dashed border-gray-300 bg-white p-4">
            ...
            <button
              onClick={login}
              className="inline-flex items-center gap-2 rounded-md border border-gray-300 bg-gray-100 px-3 py-1.5 font-mono text-sm text-gray-800 transition-colors hover:bg-gray-200 hover:text-text"
            >
      ...
      <div className="space-y-3">
        {comments.length === 0 ? (
          <div className="rounded-md border border-dashed border-gray-300 bg-white/70 py-8 text-center">
